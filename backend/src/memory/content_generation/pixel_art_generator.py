...
from memory.content_generation.audio_story_generator import (
...
def main():
    ...
    parser.add_argument(
        "--story", required=True, help="Story script or path to story script file"
    )
    ...
    parser.add_argument(
        "--openai-api-key", help="OpenAI API key for generating descriptions"
    )
...
if __name__ == "__main__":
    ...
    story_title = "The Adventures of the Magic Sword"
    story_script = story_service.get_story_script(story_title)
