...
from .chat_character_protocol import ChatCharacterProtocol
...
class ProtocolRegistry:
    ...
    def _setup_default_protocols(self) -> None:
        ...
        self.register_protocol(ChatCharacterProtocol(self.connection_manager))
    ...
    async def handle_message(
        self, connection_id: str, message_type: str, payload: Any
    ) -> bool:
        """
