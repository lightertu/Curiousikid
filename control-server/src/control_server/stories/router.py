...
from control_server.stories.dependencies import get_story_service
from control_server.stories.service import StoryService
from control_server.common.story_loader import DEFAULT_STORY_DIR
...
async def get_story_audio(
    ...
    file_path = os.path.join(DEFAULT_STORY_DIR, id, "audio.mp3")
