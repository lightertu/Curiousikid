...
import json
import logging
from typing import Any, Dict, Generic, Optional, TypeVar, Union, Tuple, List
...
def create_message(message_type: Union[MessageType, str], payload: Dict[str, Any] = None) -> str:
    """
...
def create_error_message(message: str, code: str = "general_error", details: Any = None) -> str:
    """
