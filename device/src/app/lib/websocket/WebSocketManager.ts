...
import { ChatCharacterProtocol } from './protocols/ChatCharacterProtocol';
...
export default class WebSocketManager extends EventEmitter implements WebSocketConnection {
  ...
  private readonly chatCharacterProtocol: ChatCharacterProtocol;
  ...
  constructor(url: string) {
    ...
    this.chatCharacterProtocol = new ChatCharacterProtocol(this);

    // Register protocols
    this.protocolRegistry.registerProtocol(this.storyProtocol);
    this.protocolRegistry.registerProtocol(this.chatCharacterProtocol);
  }
  ...
  public getChatCharacterProtocol(): ChatCharacterProtocol {
    return this.chatCharacterProtocol;
  }
